// BabyMonitor.swift - macOS Build (Debug Logging + Defensive)
import Cocoa
import AVFoundation
import Speech
import Vision
    ...
    func requestPermissions() {
        SFSpeechRecognizer.requestAuthorization { authStatus in
            ...
            case .authorized:
                ...
                // Check mic permission too (AVCaptureDevice)
